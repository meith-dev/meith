...
Last audited **2026-07-31** (re-audited after F55 opened Phase 5), against the working tree, not from memory:
`pnpm verify` (1973 tests), `pnpm build`, `pnpm test:e2e`, plus direct inspection of the
