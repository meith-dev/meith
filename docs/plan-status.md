...
Last audited **2026-07-30** (re-audited after F49 landed), against the working tree, not from memory:
`pnpm verify` (1364 tests), `pnpm build`, `pnpm test:e2e`, plus direct inspection of the
