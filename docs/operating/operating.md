...
Installing a board? Use the [Quickstart](../setting-up/deployment/coolify.md) or [Deploying by hand](../setting-up/deployment/docker-compose.md). Community administration belongs in the [Organiser guide](../using/organiser-guide.md).
...
[Migrating from MyBB or phpBB](../getting-started/migrating.md). Quick reference for
...
[Writing a plugin](../developing/plugins.md#writing-a-plugin) — is a change to the sources your
...
[Installing plugins and themes](../getting-started/installing.md) for the board admin's walkthrough.
...
[Docker Compose](../setting-up/deployment/docker-compose.md) for
