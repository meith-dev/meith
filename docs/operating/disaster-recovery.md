...
[requirements](../setting-up/deployment/docker-compose.md#what-you-need) have not changed because
...
front](../setting-up/deployment/docker-compose.md#5-put-a-proxy-in-front)); until propagation
...
[the Coolify guide](../setting-up/deployment/coolify.md) has a
