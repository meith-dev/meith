...
the [Quickstart](../setting-up/deployment/coolify.md) was written for.
...
Starting from the [by-hand route](../setting-up/deployment/docker-compose.md), the differences are
...
yourself; [Running on Vercel](../setting-up/deployment/vercel.md#how-the-blob-store-authenticates)
has the whole of it.
