...
everywhere, in every language you supply it for. [Languages](../operating/internationalisation.md)
...
> buttons: an image by URL (`![alt](../customization/url)`), a task-list line (`- [ ]`), and a
