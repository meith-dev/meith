...
[Development](../developing/development.md) covers the Postgres-backed
...
- [Configuration in code](../getting-started/configuration.md) — what to commit,
  what stays in the admin panel.
- [Migrating](../getting-started/migrating.md) — if the community already lives on
