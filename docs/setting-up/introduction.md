...
break the build. [Configuration in code](../getting-started/configuration.md)
...
models; plugins attach to [typed hooks](../developing/plugins.md) and
...
[the operations guides](../operating/operating.md) assume the
...
- [Deployment](./deployment/index.md) — the same board on your own
  domain.
- [Configuration in code](../getting-started/configuration.md) — what the board
  repository holds and why.
- [Themes](../developing/themes.md) and
  [plugins](../developing/plugins.md) — the extension contracts.
- [Migrating](../getting-started/migrating.md) — moving a MyBB or phpBB board
