...
shape [the marketplace](../../developing/marketplace.md) installs
...
[Consuming the board from a workspace](../../developing/development.md#consuming-the-board-from-a-workspace)
for the mechanism (`forum-web`/`meith` — the bins the compose file below
actually runs) and [the plugin API](../../developing/plugins.md) for
...
working board. See [Monitoring & alerting](../../operating/monitoring.md) once you want a
...
out](../../operating/scaling.md) is the path — the compose file
...
- **[Deploying with Coolify § Mail](./coolify.md#5-mail)** — the answer sheet for
  ...
  stack override both.
- **[Operations](../../operating/operating.md)** — the operator handbook:
...
[Backups](../../operating/backups.md), whose *Back up before
...
[the operator CLI](../../operating/operating.md#the-operator-cli) for how to run it on
this deployment, and [Upgrading a board](../../operating/upgrading.md) for how far you
