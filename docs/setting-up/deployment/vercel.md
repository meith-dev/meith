...
[Operations](../../operating/operating.md) still exists, but you run it from a checkout
...
and [Upgrading § When the build runs the migration](../../operating/upgrading.md#when-the-build-runs-the-migration)
...
- **The installer checks the schema rather than applying it.** Its first
  ...
  looks](../../developing/development.md#building-where-vercel-looks)) — so
...
[Operations § Connection pooling](../../operating/operating.md#connection-pooling) has
the full account.
...
each is in [Scaling out](../../operating/scaling.md).
...
is [Restoring from the installer](../../operating/backups.md#from-the-installer);
...
**before** you move DNS. [Disaster recovery](../../operating/disaster-recovery.md) is the
...
[Operations § Troubleshooting](../../operating/operating.md#troubleshooting) covers the
