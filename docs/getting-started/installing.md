...
[Write your first plugin](../developing/first-plugin.md).
...
[Operations](../operating/operating.md#migrations).
...
- [Write your first plugin](../developing/first-plugin.md) — the walkthrough from an empty
  directory to a plugin running inside a board.
- [Plugins](../developing/plugins.md) — the full plugin API: hooks, lifecycle, and what a
  plugin may and may not do.
- [Themes](../developing/themes.md) — the theme API: slots, view models, and tokens.
- [The marketplace](../developing/marketplace.md) — how a listing is reviewed and
  published.
