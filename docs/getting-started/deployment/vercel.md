...
[Operations](../../guides/operations/operating.md) still exists, but you run it from a checkout
...
[Monitoring § Driving the tick over HTTP](../../guides/operations/monitoring.md#driving-the-tick-over-http)
...
[Operations § Connection pooling](../../guides/operations/operating.md#connection-pooling) has
the full account.
...
each is in [Scaling out](../../guides/operations/scaling.md).
...
[Disaster recovery § Restore the board](../../guides/operations/disaster-recovery.md#3-restore-the-board);
...
**before** you move DNS. [Disaster recovery](../../guides/operations/disaster-recovery.md) is the
...
[Disaster recovery](../../guides/operations/disaster-recovery.md#4-the-uploads-when-they-lived-elsewhere)
...
| You want to | Read |
|---|---|
| Understand the driver set in depth | [Scaling out](../../guides/operations/scaling.md) |
| Set up metrics and alerting | [Monitoring & alerting](../../guides/operations/monitoring.md) |
| Move between versions | [Upgrading a board](../../guides/operations/upgrading.md) |
| Run the board day to day | [Operations](../../guides/operations/operating.md) |
