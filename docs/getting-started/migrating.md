...
[Operations](../operating/operating.md#troubleshooting).
...
| Rebuild groups and forum permissions | [The organiser's guide](../using/organiser-guide.md) |
| Hand the approval queue and reports to your moderators | [The moderator's guide](../using/moderation-guide.md) |
| Run backups, upgrades and routine maintenance from here on | [Operations](../operating/operating.md) |
