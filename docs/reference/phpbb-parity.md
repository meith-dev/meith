...
plausible one-to-one translation, and [Migrating from MyBB or phpBB](../guides/migrating.md)
...
in [Migrating from MyBB or phpBB](../guides/migrating.md#what-comes-across-and-what-does-not) —
...
| You want to | Read |
|---|---|
| Run the import itself | [Migrating from MyBB or phpBB](../guides/migrating.md) |
| Understand a Meith design decision this page didn't re-derive | [MyBB parity decisions](./mybb-parity.md) |
| Rebuild groups and forum permissions | [The organiser's guide](../guides/community/organiser-guide.md) |
