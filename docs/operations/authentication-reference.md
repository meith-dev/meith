# Authentication behavior and recovery

Look up the behavior of two-factor authentication, sessions, sign-in providers and passkeys. Member instructions are in Account security; operator setup is in Authentication settings.
...
[the operator CLI](operator-cli.md#the-operator-cli) for how to reach it on
your deployment.
