...
Both are no-ops for `forum-web`/`community` used the way `docs/development.md`, "Consuming the board from a workspace" describes — a real external board never sets either.
