...
| Deploying one on a server you rent | [Self-hosting on a VPS](./self-hosting.md) |
...
| [`self-hosting.md`](./self-hosting.md) | **Deploying it.** A server, Docker Compose, a reverse proxy, TLS, backups, upgrades and the operator CLI. |
