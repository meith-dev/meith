...
payload — is generated into [Plugin hooks](./plugin-hooks.md).
...
against. The same policy as the [theme API](./theme-api.md#versioning)
...
[Plugin hooks](./plugin-hooks.md) is written by
