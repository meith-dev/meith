...
[timed-grant capability](../../docs/developing/plugins.md#timed-group-grants), and
...
[demo mode](../../docs/operating/demo-mode.md#the-shop-and-a-stripe-that-is-not-stripe).
