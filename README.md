...
| Using your board | [`forums.md`](./docs/forums.md) | The board's shape and who may do what inside it: the forum tree, a forum's options, how a permission resolves, the matrix, and what a moderator appointment grants. |
| Using your board | [`groups.md`](./docs/groups.md) | What a group carries: board-wide permissions, the daily allowances, colours and badges, display groups, the groups a plugin may grant, and the rules that promote members automatically. |
| Using your board | [`antispam.md`](./docs/antispam.md) | The registration challenge, the limits on pages nobody has signed in to, the three login counters, and the hourly allowances — what each is worth and what it costs a real visitor. |
