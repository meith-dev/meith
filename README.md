...
| Running a board | [`single-sign-on.md`](./docs/single-sign-on.md) | Federated sign-in and passkeys: what turning a provider on means for your members, how GitHub, Google and any OpenID Connect provider are configured, and how an account is found or opened on a first sign-in. |
