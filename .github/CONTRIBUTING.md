...
[docs/developing/development.md](../docs/developing/development.md) is the real document: running
...
Releases are cut from tags by maintainers — [docs/developing/release.md](../docs/developing/release.md)
