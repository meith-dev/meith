 ...
 * packages/create-meith/src/bin.ts — see docs/contributing/release.md — and kept honest
 ...
 * string nothing currently checks (see docs/customization/plugins.md's Versioning
