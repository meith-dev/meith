...
CREATE TABLE "community_moderators" (
	"id" integer PRIMARY KEY GENERATED BY DEFAULT AS IDENTITY (sequence name "community_moderators_id_seq" INCREMENT BY 1 MINVALUE 1 MAXVALUE 2147483647 START WITH 1 CACHE 1),
	"community_id" integer NOT NULL,
	"user_id" integer,
	"group_id" integer,
	"cascade_to_subcommunities" boolean DEFAULT false NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "community_password_grants" (
...
ALTER TABLE "community_moderators" ADD CONSTRAINT "community_moderators_community_id_communities_id_fk" FOREIGN KEY ("community_id") REFERENCES "public"."communities"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "community_moderators" ADD CONSTRAINT "community_moderators_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "community_moderators" ADD CONSTRAINT "community_moderators_group_id_usergroups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."usergroups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "community_password_grants" ADD CONSTRAINT "community_password_grants_community_id_communities_id_fk" FOREIGN KEY ("community_id") REFERENCES "public"."communities"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "community_permissions" ADD CONSTRAINT "community_permissions_community_id_communities_id_fk" FOREIGN KEY ("community_id") REFERENCES "public"."communities"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "community_permissions" ADD CONSTRAINT "community_permissions_group_id_usergroups_id_fk" FOREIGN KEY ("group_id") REFERENCES "public"."usergroups"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "communities_read" ADD CONSTRAINT "communities_read_user_id_users_id_fk" FOREIGN KEY ("user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "communities_read" ADD CONSTRAINT "communities_read_community_id_communities_id_fk" FOREIGN KEY ("community_id") REFERENCES "public"."communities"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "community_moderators_user_key" ON "community_moderators" USING btree ("community_id","user_id") WHERE "community_moderators"."user_id" is not null;--> statement-breakpoint
CREATE UNIQUE INDEX "community_moderators_group_key" ON "community_moderators" USING btree ("community_id","group_id") WHERE "community_moderators"."group_id" is not null;--> statement-breakpoint
CREATE INDEX "community_moderators_user_idx" ON "community_moderators" USING btree ("user_id");--> statement-breakpoint
CREATE INDEX "community_moderators_group_idx" ON "community_moderators" USING btree ("group_id");--> statement-breakpoint
CREATE UNIQUE INDEX "community_password_grants_pkey" ON "community_password_grants" USING btree ("session_id","community_id");--> statement-breakpoint
CREATE UNIQUE INDEX "community_permissions_pkey" ON "community_permissions" USING btree ("community_id","group_id");--> statement-breakpoint
CREATE INDEX "community_permissions_group_idx" ON "community_permissions" USING btree ("group_id");--> statement-breakpoint
CREATE UNIQUE INDEX "community_subscriptions_pkey" ON "community_subscriptions" USING btree ("user_id","community_id");--> statement-breakpoint
CREATE INDEX "community_subscriptions_community_idx" ON "community_subscriptions" USING btree ("community_id");--> statement-breakpoint
CREATE UNIQUE INDEX "communities_parent_slug_key" ON "communities" USING btree ("parent_id","slug") WHERE "communities"."parent_id" is not null;--> statement-breakpoint
CREATE UNIQUE INDEX "communities_root_slug_key" ON "communities" USING btree ("slug") WHERE "communities"."parent_id" is null;--> statement-breakpoint
CREATE INDEX "communities_parent_order_idx" ON "communities" USING btree ("parent_id","display_order");--> statement-breakpoint
CREATE INDEX "communities_path_idx" ON "communities" USING btree ("path");--> statement-breakpoint
CREATE UNIQUE INDEX "communities_legacy_mybb_fid_key" ON "communities" USING btree ("legacy_mybb_fid") WHERE "communities"."legacy_mybb_fid" is not null;--> statement-breakpoint
CREATE UNIQUE INDEX "communities_read_pkey" ON "communities_read" USING btree ("user_id","community_id");--> statement-breakpoint
...
CREATE INDEX "posts_community_visibility_idx" ON "posts" USING btree ("community_id","created_at" DESC NULLS LAST) WHERE "posts"."visibility" <> 'visible';--> statement-breakpoint
...
CREATE INDEX "threads_community_listing_idx" ON "threads" USING btree ("community_id","is_sticky" DESC NULLS LAST,"last_post_at" DESC NULLS LAST) WHERE "threads"."visibility" = 'visible';--> statement-breakpoint
CREATE INDEX "threads_community_listing_all_idx" ON "threads" USING btree ("community_id","is_sticky" DESC NULLS LAST,"last_post_at" DESC NULLS LAST);--> statement-breakpoint
