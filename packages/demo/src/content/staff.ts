...
export const STAFF_THREADS: readonly DemoThread[] = [
  ...
  },
  {
    ...
    replies: [
      { author: 'admin', hoursAfter: 5, message: 'Third, and say the €2 out loud. Every fee rise in this club has been fought over a number nobody was ever told.' },
      { author: 'dara', hoursAfter: 11, message: 'Third. The second one punishes the people who turn up, and they are the people we cannot afford to annoy.' },
      { author: 'mairead', hoursAfter: 20, message: 'Third, with the family rate uncapped. Four households have more than two playing. Capping it saves us about €200 and looks mean for €200.' },
      { author: 'kev', hoursAfter: 26, message: 'One thing: whatever we pick, put the "nobody is ever turned away for not being able to pay" line in the same post. Not a footnote three weeks later.' },
      { author: 'siobhan', hoursAfter: 44, quotes: 4, message: 'Agreed, and it should have been in the draft. Going to the AGM as option three, uncapped, with that line in bold.' },
      { author: 'vex', hoursAfter: 70, message: 'For the record the gaming side pays the adult social rate and nobody has ever queried it. An 8% rise on €25 is not going to start now.' },
    ],
  },
  {
    forum: 'committee',
    ...
    replies: [
      { author: 'mairead', hoursAfter: 2, message: 'No, and thank you for making it a decision rather than a conversation.' },
      { author: 'admin', hoursAfter: 6, message: 'No. And worth saying: €6,000 is two years of drainage. It is a real cost and we should be honest that we are choosing to pay it.' },
      { author: 'dara', hoursAfter: 9, message: 'No from me. I would also like us to write the policy now, in one sentence, so the next one is answered in a day rather than a fortnight.' },
      { author: 'vex', hoursAfter: 14, message: 'No. It would land particularly badly on our side, where half the audience is under twenty-five and the ads are already everywhere.' },
      { author: 'kev', hoursAfter: 26, message: 'Unanimous then. Sentence for the policy: "No sponsorship from gambling, alcohol brands aimed at under-25s, or anything that would appear on a juvenile jersey."' },
      { author: 'siobhan', hoursAfter: 50, quotes: 5, message: 'That is the policy, minuted, and it goes in the open moderation forum so members can see what we said no to.' },
    ],
  },
  {
    forum: 'committee',
    ...
    replies: [
      { author: 'siobhan', hoursAfter: 4, message: 'We do about thirty-five hours as it stands. The risk is not the hours, it is a bad winter where the pitch is shut for six weeks and we are technically in breach.' },
      { author: 'dara', hoursAfter: 8, message: 'Ring them and ask how closures are treated. I would put money on there being a standard answer they give twenty clubs a year.' },
      { author: 'admin', hoursAfter: 30, message: 'Rang them. Closures for weather do not count against you, they want it noted on the quarterly form and that is all.' },
      { author: 'kev', hoursAfter: 44, message: 'Then it is four forms a year for seven thousand euro. I will do the forms.' },
      { author: 'mairead', hoursAfter: 50, message: 'Kev has now volunteered for two things in one week and I would like somebody to check on him.' },
      { author: 'siobhan', hoursAfter: 74, message: 'Applying. Tomás and Noelle have the financial section done and Rosa has been through it — she has written eleven of these.' },
    ],
  },
  {
    forum: 'committee',
    ...
    replies: [
      { author: 'siobhan', hoursAfter: 6, message: 'The no-budget line is the one that will get this through without a row, and you are right about why.' },
      { author: 'admin', hoursAfter: 11, message: 'One change: "the section officer is elected by the section" rather than appointed by you. Not because anybody minds you, because in four years it will not be you.' },
      { author: 'vex', hoursAfter: 14, quotes: 2, message: 'Fair and better. Changed.' },
      { author: 'mairead', hoursAfter: 26, message: 'Add a line that the welfare officer covers the section the same as the pitch. It is already true in practice and it should be true on paper.' },
      { author: 'dara', hoursAfter: 30, message: 'Fifty-one members and a line in the constitution. Two years ago it was five lads who could not be bothered going home after training.' },
      { author: 'siobhan', hoursAfter: 74, message: 'Going to the AGM as drafted. Vex is speaking to it, not me.' },
    ],
  },
  {
    forum: 'committee',
    ...
    replies: [
      { author: 'vex', hoursAfter: 3, message: 'Genuinely sorry. If it is going to be a real cost every year we should talk about whether the section carries some of it.' },
      { author: 'siobhan', hoursAfter: 5, quotes: 1, message: 'It is not and we will not. Every section costs something and the juveniles cost far more than €760.' },
      { author: 'admin', hoursAfter: 30, message: 'Broker came back: declared as a social activity it is €3,610. Same cover, and it is a more accurate description of eleven people on a headset.' },
      { author: 'dara', hoursAfter: 44, message: 'One phone call for €570. Put that in the AGM notes, it is the kind of thing members never see.' },
    ],
  },
  {
    forum: 'committee',
    ...
    replies: [
      { author: 'admin', hoursAfter: 4, message: 'The €1,900 patch that failed last year is the whole argument for the fourteen. Put both numbers in the same slide.' },
      { author: 'dara', hoursAfter: 9, message: 'Agreed. And can we get the guy who did it to write two paragraphs a member can read? "Ten-year guarantee" means more from him than from us.' },
      { author: 'kev', hoursAfter: 20, message: 'With the grant at seven, the fund at six-two and the quiz money, we are about €800 short. That is one more quiz.' },
      { author: 'mairead', hoursAfter: 26, message: 'The juvenile section will run the one more quiz. Say the word and it is done by March.' },
      { author: 'siobhan', hoursAfter: 44, message: 'Right — fourteen, to the AGM, with the failed patch beside it and Mairéad\'s quiz as the gap. That is a plan rather than an ask.' },
    ],
  },
  {
    forum: 'committee',
...

  {
    ...
    replies: [
      { author: 'kev', hoursAfter: 9, message: 'The reversible-thing line is the best advice on this board. I have never once regretted waiting an hour.' },
      { author: 'tinker', hoursAfter: 26, message: 'Adding the one from our side: never moderate at 1am after a bad raid. It is never as bad in the morning and I have twice been wrong.' },
      { author: 'dara', hoursAfter: 50, message: 'And if you act on something involving somebody you play with, say so here. Not because it is wrong, because it is better said than found out.' },
    ],
  },
  {
    forum: 'staffdesk',
    ...
    replies: [
      { author: 'siobhan', hoursAfter: 3, message: 'Yes: anything involving a child, anything that is a threat, and anything that is a pattern after two conversations. The first two are immediate and the third is the committee, not one person.' },
      { author: 'moderator', hoursAfter: 6, message: 'And a ban here is a club matter, not a website matter. Somebody banned from the board is somebody the committee needs to have talked to about the clubhouse.' },
      { author: 'mairead', hoursAfter: 11, message: 'That is the part people miss. This is not a forum with members, it is a club with a forum.' },
      { author: 'kev', hoursAfter: 20, message: 'Worth writing those three lines into the open moderation forum. Members reading "we have banned two accounts and both were spam" is worth more than any policy.' },
      { author: 'tinker', hoursAfter: 44, message: 'That answers it, and I would not have known the answer if I had needed it at eleven at night. Which was the question.' },
    ],
  },
  {
    forum: 'staffdesk',
    ...
    replies: [
      { author: 'moderator', hoursAfter: 4, message: 'The paperwork matters for the fifth one though. The four-warning member left because there was a record, not because there was a conversation.' },
      { author: 'siobhan', hoursAfter: 9, message: 'Both are true. Keep it, use it rarely, and never issue one instead of a conversation — issue it after.' },
      { author: 'vex', hoursAfter: 20, message: 'The expiry is the bit I would change. Ours never expire and a warning from two years ago should not be sitting on somebody who has been fine since.' },
      { author: 'admin', hoursAfter: 26, message: 'They can expire — it is a setting per warning type. Six months for the mild ones and never for the serious ones is what most boards land on.' },
      { author: 'dara', hoursAfter: 44, quotes: 4, message: 'Setting the mild ones to six months. That is a better answer than binning the system.' },
    ],
  },
  {
    forum: 'staffdesk',
    ...
    replies: [
      { author: 'moderator', hoursAfter: 2, message: 'Agreed. Something answerable by anybody who has stood at the pitch once: what is across the road from the clubhouse.' },
      { author: 'kev', hoursAfter: 5, message: 'A shop, a school and a graveyard. Three right answers, which is a different problem.' },
      { author: 'admin', hoursAfter: 9, quotes: 2, message: 'It takes any of a list of answers, so three right answers is fine. That is what the field is for.' },
      { author: 'vex', hoursAfter: 20, message: 'Changed, with four accepted answers including one misspelling. Spam is unchanged at under five a day and nobody has failed it since.' },
      { author: 'tinker', hoursAfter: 200, message: 'Six weeks on: no real person has failed it, no spam has got through. Leaving it alone.' },
    ],
  },
  {
    forum: 'staffdesk',
    ...
    replies: [
      { author: 'siobhan', hoursAfter: 2, message: 'Same message to both, word for word, and tell them it is the same message. It removes the entire "what did he say to you" round.' },
      { author: 'dara', hoursAfter: 5, message: 'And do not adjudicate. "Both of you are fine, that thread was not, leave it there" is the answer that ages best.' },
      { author: 'mairead', hoursAfter: 9, message: 'Would either of them take a phone call rather than a message? Half of these are tone rather than content.' },
      { author: 'moderator', hoursAfter: 26, message: 'Rang both. Ten minutes each. One of them had already sent the other a message before I got to him.' },
      { author: 'kev', hoursAfter: 30, message: 'They were both at the quiz on the same team on Friday. Filing that under solved.' },
    ],
  },
  {
    forum: 'staffdesk',
    ...
    replies: [
      { author: 'moderator', hoursAfter: 3, message: 'It is the obvious move. Nine times in ten they have no idea and are mortified.' },
      { author: 'admin', hoursAfter: 6, message: 'And keep the permission trick in your back pocket. It is the right tool and it is the wrong first step.' },
      { author: 'kev', hoursAfter: 26, message: 'Talked to them. Mortified, exactly as predicted. One thread now, updated as things sell, and it is a better thread than the six were.' },
      { author: 'tinker', hoursAfter: 44, message: 'Filing "have you tried telling them" under things I have to relearn every six months.' },
    ],
  },
  {
    forum: 'staffdesk',
  ...
  },
  {
    ...
    replies: [
      { author: 'vex', hoursAfter: 4, message: 'Four hours overnight is the one to fix and I have said I will take the overnight approvals. Give me the fortnight and this will read under an hour.' },
      { author: 'admin', hoursAfter: 9, message: 'Seven from the subs page is the number I care about. Paying for something and being asked to make an account in the same minute is working.' },
      { author: 'dara', hoursAfter: 20, message: 'Keep posting these. It took ten minutes to write and it is the only reason anybody knows the queue is fine.' },
    ],
  },
  ...
  },
  {
    ...
    replies: [
      { author: 'mairead', hoursAfter: 5, message: 'Camp helper forms are going out this week for that reason. Anyone who has helped before is already vetted and does not need to do anything.' },
      { author: 'vex', hoursAfter: 11, message: 'Two of ours need it for the Sunday block. Both forms in on Friday.' },
      { author: 'dara', hoursAfter: 26, message: 'Is there anything the club can do to speed it up, or is eleven weeks just eleven weeks?' },
      { author: 'siobhan', hoursAfter: 30, quotes: 3, message: 'Eleven weeks is eleven weeks. The only thing that helps is the forms being right first time, and about a third of ours come back for a missing signature.' },
      { author: 'mairead', hoursAfter: 50, message: 'I will check every form before it goes in from now on. Ten minutes each and it saves three weeks each.' },
    ],
  },
  {
    forum: 'welfare',
    ...
    replies: [
      { author: 'mairead', hoursAfter: 3, message: 'Send it to me and it goes into the club policy word for word. It is the same policy as the pitch, which is the point.' },
      { author: 'siobhan', hoursAfter: 8, message: 'And it goes to the AGM as part of the section wording, so it is the club\'s rule rather than yours. That protects you as much as anybody.' },
      { author: 'admin', hoursAfter: 14, message: 'The no-private-messages rule can be enforced rather than asked for — the permission is per group, so an under-18 group without private messages is a setting, not a promise.' },
      { author: 'vex', hoursAfter: 20, quotes: 3, message: 'Do it. I would much rather the software said no than me having to.' },
      { author: 'mairead', hoursAfter: 30, message: 'Policy updated, group created, and the parent who asked has been sent the whole thing. She replied to say it was more than the school gave her.' },
    ],
  },
  {
    forum: 'welfare',
    ...
    replies: [
      { author: 'vex', hoursAfter: 2, message: 'Correct, the first hour is never streamed. I will put that in the pinned post in bold rather than in the third paragraph.' },
      { author: 'siobhan', hoursAfter: 6, message: 'Put it on the membership form too, beside the photo tick. That is where a parent is actually reading.' },
      { author: 'mairead', hoursAfter: 20, message: 'Both done and the parent is happy. She has since signed the consent for the photos, which she had left blank the first time.' },
      { author: 'dara', hoursAfter: 26, message: 'That last sentence is the whole argument for answering these properly.' },
    ],
  },
  {
    forum: 'welfare',
    ...
    replies: [
      { author: 'mairead', hoursAfter: 1, message: 'Ask them, and offer the second one before they have to ask for it. Somebody who has had to make this request once does not want to make it twice.' },
      { author: 'dara', hoursAfter: 5, message: 'Asked. They want the old ones done too. Editing them this evening.' },
      { author: 'siobhan', hoursAfter: 9, message: 'And nothing said publicly about why. Anyone who notices a name is gone can ask me and I will tell them it is a family\'s decision and nothing else.' },
      { author: 'dara', hoursAfter: 26, message: 'Eleven reports, took twenty minutes. Going to write the juveniles up by first name only from here on unless a parent has said otherwise — it reads fine and it saves this happening again.' },
      { author: 'mairead', hoursAfter: 30, quotes: 4, message: 'That should be the club rule and I am putting it in the policy. Well spotted.' },
    ],
  },
  {
    forum: 'welfare',
...

  {
    ...
    replies: [
      ...
      { author: 'kev', hoursAfter: 9, message: 'The one that did not go well still bothers me and I would still do it again, which I think is the job.' },
      { author: 'tinker', hoursAfter: 20, message: 'From three timezones away: this is the only committee I have ever been on where nobody has once said "that is not my job".' },
      { author: 'mairead', hoursAfter: 30, message: 'Right, that is enough of that. Back to the rota.' },
    ],
  },
  {
    forum: 'staffroom',
    ...
    replies: [
      { author: 'tinker', hoursAfter: 3, message: '24th to the 26th. Christmas is not a thing in my house and the queue is a nice quiet job.' },
      ...
      { author: 'dara', hoursAfter: 30, message: 'Covered in a day, nobody did more than three days, and I did none of it. Excellent work everybody.' },
    ],
  },
  {
    forum: 'staffroom',
    ...
    replies: [
      { author: 'moderator', hoursAfter: 2, message: 'I will take both. They are quiet forums and it is ten minutes a day.' },
      { author: 'siobhan', hoursAfter: 6, message: 'Handed over, and it is handed straight back when you say so. Go and do the work thing.' },
      { author: 'kev', hoursAfter: 200, message: 'Back. Thank you, all of you, and the buy-and-sell is tidier than I left it, which is mildly insulting.' },
  ...
  },
  {
    ...
    replies: [
      { author: 'moderator', hoursAfter: 3, message: 'Yes, and it changed one thing measurably: people stopped asking "who do I ask about this". They just reply to whichever coloured name is in the thread.' },
      { author: 'mairead', hoursAfter: 8, message: 'Parents notice immediately. Half of them cannot tell you what a super moderator is and all of them know a red name means the buck stops there.' },
      { author: 'kev', hoursAfter: 14, message: 'Downside: a coloured name in a thread ends the conversation a bit. I have started deliberately not posting in some threads until it has run.' },
      { author: 'dara', hoursAfter: 20, quotes: 3, message: 'That is the real cost of it and it is worth naming. Post as late as you can and let the members answer each other first.' },
      { author: 'vex', hoursAfter: 26, message: 'On our side the colours did more than the titles ever did. Nobody reads a title under a name. Everybody sees a colour.' },
    ],
  },
  {
    forum: 'staffroom',
    ...
    replies: [
      { author: 'siobhan', hoursAfter: 5, message: 'No objection at all from me. The only question is whether she knows it is a job rather than a compliment.' },
      { author: 'moderator', hoursAfter: 9, message: 'Sit her down for twenty minutes with the queue first. Everybody says yes and then discovers the reports are the actual work.' },
      { author: 'kev', hoursAfter: 20, message: 'Agreed, and she has already been doing the unpaid half for two years.' },
      { author: 'mairead', hoursAfter: 30, message: 'Asking her properly this week, with the twenty minutes and the honest description. If she says yes she gets the juvenile forums and nothing else.' },
      { author: 'admin', hoursAfter: 44, message: 'That is how it should go — appointed to a corner, not handed the whole board. The permissions do that per forum and nobody has to be trusted with more than they asked for.' },
    ],
  },
  {
    forum: 'staffroom',
