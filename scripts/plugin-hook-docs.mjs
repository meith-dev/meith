...
function render({ hooks, signatures, regions, wired }) {
  ...
  push(
    ...
    '-->',
    '',
    `${hooks.length} hooks: ${filters} filters and ${hooks.length - filters} events. ${regions.length} UI regions.`,
    '',
    `${wired.size} hooks have call sites in this build. The Wired column is generated from the source tree.`,
    '',
