    ...
    <div className="mx-auto flex w-full max-w-5xl flex-col gap-5 px-6 py-8">
      <div className="flex flex-wrap items-start justify-between gap-3">
        ...
        <div className="flex gap-3">
          {markReadAction !== null && <form action={markReadAction} method="post"><button type="submit" className="text-sm text-muted-foreground hover:text-foreground">Mark read</button></form>}
