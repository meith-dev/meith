...
const BUTTON =
  'min-w-8 px-2 py-1.5 font-mono text-[0.75rem] uppercase tracking-[0.05em] text-muted-foreground transition-colors duration-[160ms] hover:text-foreground'
...
export function EditorToolbar({
  ...
  return (
    <div
      ...
      className="flex flex-wrap gap-0.5 border-b border-border py-2"
    >
