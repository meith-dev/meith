...
import { isEmptyRegion, LABEL, QUIET_LINK, TOUCH } from '../shared'
...
const ACTION = `${LABEL} inline-flex items-center py-2 ${QUIET_LINK} ${TOUCH}`
...
export function PostActions({
  ...
  const c = (key: string) => fromSlotCopy(copy, `meith.postActions.${key}`)
