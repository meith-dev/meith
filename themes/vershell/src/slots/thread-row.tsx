...
export function ThreadRow({
  ...
  const c = (key: string) => fromSlotCopy(copy, `vershell.threadRow.${key}`)
  ...
  return (
    <li
      ...
      className={`group grid grid-cols-[minmax(0,1fr)] gap-x-6 gap-y-2 px-2 py-4 first:border-t-0 @3xl/card:first:border-t ${RULE} ${ROW_HOVER} @3xl/card:grid-cols-[minmax(0,1fr)_9rem_15rem] @3xl/card:items-baseline ${hidden ? tint : ''}`}
    >
