...
export default function DocsIndexPage() {
  return (
    <>
      ...
      <Lead>
        meith collects the pieces web developers usually scatter across multiple
        windows — project folders, code files, terminal sessions, a live
        localhost preview, run commands, dev-server logs, plugins, and agent
        chats — and puts them in one place. A shared tool system connects
        everything, so the visual app, the terminal command, a plugin, and an AI
        agent all act on the exact same project state instead of their own
        isolated views.
      </Lead>
      ...
      <UL>
        <li>Open a web project folder in its own workspace.</li>
        <li>Browse and edit your app&apos;s code in the integrated editor.</li>
        <li>Start and stop your dev server from the top bar.</li>
        <li>Preview the running app on localhost in an embedded browser tab.</li>
        <li>Watch the preview update and read dev-server logs in the window.</li>
        <li>
          Split panes to arrange your preview, editor, terminal, or agent side by
          side.
        </li>
        <li>
          Ask an agent to build features in your project&apos;s context — editing
      ...
      <CardGrid>
        ...
        <DocCard href="/docs/agents" title="Working with agents">
          Ask agents to build features in your project and review what they do.
        </DocCard>
