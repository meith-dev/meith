              ...
              <li key={entry.id} className="rounded-lg border border-border bg-card p-3">
                <div className="flex flex-wrap items-baseline justify-between gap-2 text-sm">
                  <span className="font-medium">
                    {/*
                      Unknown action ids fall through to the raw string. The log
                      is written by ten features and will be written by more; a
                      screen rendering only what it has heard of would hide the
                      newest entries, which are the ones somebody is looking for.
                    */}
