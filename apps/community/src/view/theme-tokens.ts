...
const GROUPS: readonly GroupSpec[] = [
  {
    ...
    tokens: [
      [
        'primary',
        'Button and link accent',
        'The fill of “Post reply”, “Search” and every other primary button, and the colour a link is underlined in.',
      ],
      [
        'primary-hover',
        'Accent under the cursor',
        'The same button while it is hovered. Usually a step darker than the accent in light mode and a step lighter in dark.',
      ],
      [
        'primary-foreground',
        'Text on the accent',
        'Sits on top of the accent colour, so it needs to contrast with it — not with the page.',
      ],
      [
        'ring',
        'Focus outline',
        'Drawn around whatever has keyboard focus. Keep it visible against both the page and the panels.',
      ],
    ],
  },
  {
    ...
    tokens: [
      [
        'background',
        'Page background',
        'Behind the whole board. Also becomes the browser’s own toolbar colour on mobile.',
      ],
      ['foreground', 'Body text', 'Ordinary text on the page background.'],
      [
        'surface',
        'Band background',
        'The header, a table’s heading row, and a panel’s own toolbar. Sits between the page and a panel.',
      ],
      ...
      [
        'muted',
        'Quiet surface',
        'Table headers, disabled controls and other backgrounds that should recede.',
      ],
      ...
      [
        ...
        'Contrast with the secondary fill, not with the page.',
      ],
      ...
      [
        'input',
        'Field outline',
        'Deliberately darker than a rule: a field’s edge is information, a rule between two rows is not.',
      ],
      [
        'shadow-tint',
        'Panel shadow colour',
        'The colour a panel’s shadow is drawn in. Needs to be far stronger in dark mode than in light — a faint shadow is invisible on a near-black page.',
      ],
    ],
  },
  {
    ...
    tokens: [
      ...
      [
        ...
        'Text on the destructive control',
        'Contrast with the destructive fill.',
      ],
    ],
  },
  {
    ...
    tokens: [
      [
        'forum-unread',
        'Forum with new posts',
        'The forum name when there is something unread in it.',
      ],
  ...
  },
  {
    ...
    tokens: [
      ...
      [
        'post-own',
        'Your own post',
        'A gentle tint so a member can find themselves in a long thread.',
      ],
  ...
  },
  {
    ...
    tokens: [
      [
        'radius',
        'Corner rounding',
        'A CSS length. `0px` for square corners, `0.5rem` for the default, `0.75rem` for softer ones.',
        'length',
      ],
      [
        'density-unit',
        'Spacing step',
        'Every gap on the board is a multiple of this. Lower it for a denser board.',
        'length',
      ],
      [
        'elevation',
        'Panel shadow',
        'A CSS `box-shadow`, or `none` for a flat board with no shadows at all. Its colour is “Panel shadow colour” above, so this is only the geometry.',
        'text',
      ],
      [
        'font-sans-stack',
        'Body font',
        'The face the whole board is read in. A CSS font stack — the browser uses the first name it has.',
        'text',
      ],
      [
        'font-heading-stack',
        'Heading font',
        'The face headings are set in. Defaults to the body font, so the board reads in one voice; set it to something else — `Georgia, ui-serif, serif` needs no download — to give headings a voice of their own.',
        'text',
      ],
      [
        'font-mono-stack',
        'Monospace font',
        'Used for code blocks and token values. A CSS font stack.',
        'text',
      ],
    ],
  },
